...
OUTFILE=$DIR/.env
BARTONCOMMON_TOP=$DIR/..
IMAGE_REPO="ghcr.io/rdkcentral/bartoncommon_builder"
...
echo "BARTONCOMMON_TOP=$BARTONCOMMON_TOP" >> $OUTFILE
...
NETWORK_NAME="$USER-bartoncommon-ip6net"
IPV6_SUBNET="fd01:$(echo $USER | sha256sum | cut -c1-4)::/64"
