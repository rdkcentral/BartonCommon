...
function(bcommon_configure_glib)
    ...
    if (${GIO_glib-2.0_VERSION} VERSION_LESS_EQUAL 2.66)
        ...
        list(APPEND GIO_LIBRARIES ${GLIB_POLYFILL_LIBRARIES})
        list(APPEND XTRA_DEFINES HAVE_GLIB_POLYFILL)
    endif()

    foreach(MY_TARGET ${MY_TARGETS})
        message(STATUS "enabling glib for ${MY_TARGET}")
        target_include_directories(${MY_TARGET} PRIVATE ${GIO_INCLUDE_DIRS})
        target_link_libraries(${MY_TARGET} PUBLIC ${GIO_LIBRARIES})
        target_compile_definitions(${MY_TARGET} PRIVATE ${XTRA_DEFINES})
    endforeach()
endfunction()
